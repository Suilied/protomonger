...
namespace RVO {
	...
	public:
		...
		RVOSimulator(float timeStep, float neighborDist, size_t maxNeighbors,
					 float timeHorizon, float timeHorizonObst, float radius, float flockingRadiusScale,
		...
		size_t addAgent(const Vector2 &position, float neighborDist,
						...
						float timeHorizonObst, float radius, float flockScale, float maxSpeed,
		...
		/*
		* \brief	Removes an obstacle from the simulation
		* \param	obstacleId	id for the obstacle to be removed
		*/
		void removeObstacle(const size_t obstacleId);
		...
		void setAgentDefaults(float neighborDist, size_t maxNeighbors,
							  ...
							  float radius, float flockScale, float maxSpeed,
							  const Vector2 &velocity = Vector2());
		...
		/*
		*  \brief	Sets the agents target position that it should try to move towards
		*/
		void setAgentSeekTarget(size_t agentNo, const Vector2& seekTargetPos);

		/*
		*  \brief	Sets wether or not the agent should use flocking
		*/
		void setAgentFlocking(size_t agentNo, bool doFlock);

		/*
		*  \brief	Sets how much the flocking algo should influence our velocity
		*/
		void setAgentFlockingFactor(size_t agentNo, float flockingFactor);
